...
VALUES
    (11, 1, 3, 1, '2019-08-01', '2019-08-10'), /* California deals */
    (12, 1, 3, 1, '2019-08-03', '2019-08-08'),
    (13, 1, 3, 1, '2019-08-05', '2019-08-14'),
    (14, 1, 3, 2, '2019-08-06', '2019-08-11'),
    (15, 1, 3, 1, '2019-08-07', '2019-08-18'),
    (16, 1, 3, 1, '2019-08-10', '2019-08-15'),
    (17, 1, 4, 2, '2019-08-13', '2019-08-20'),
    (18, 1, 4, 1, '2019-08-17', '2019-08-21'),
    (19, 1, 4, 2, '2019-08-20', NULL),
    (20, 1, 4, 3, '2019-08-21', NULL),
    (21, 2, 6, 1, '2019-08-01', '2019-08-10'), /* Chicago deals */
    (22, 2, 6, 1, '2019-08-03', '2019-08-10'),
    (23, 2, 6, 2, '2019-08-05', '2019-08-15'),
    (24, 2, 6, 1, '2019-08-07', '2019-08-11'),
    (25, 2, 6, 1, '2019-08-09', '2019-08-19'),
    (26, 2, 7, 2, '2019-08-10', '2019-08-14'),
    (27, 2, 7, 1, '2019-08-12', '2019-08-21'),
    (28, 2, 7, 1, '2019-08-15', '2019-08-20'),
    (29, 2, 7, 1, '2019-08-20', NULL),
    (30, 2, 7, 3, '2019-08-21', NULL),
    (31, 2, 9, 1, '2019-08-01', '2019-08-18'), /* Denver deals */
    (32, 2, 9, 1, '2019-08-03', '2019-08-07'),
    (33, 2, 9, 1, '2019-08-05', '2019-08-15'),
    (34, 2, 10, 2, '2019-08-06', '2019-08-11'),
    (35, 2, 10, 1, '2019-08-11', '2019-08-19'),
    (36, 2, 10, 1, '2019-08-14', '2019-08-18'),
    (37, 2, 10, 2, '2019-08-17', '2019-08-21'),
    (38, 2, 10, 1, '2019-08-19', '2019-08-21'),
    (39, 2, 10, 1, '2019-08-20', NULL),
    (40, 2, 10, 3, '2019-08-21', NULL);
...
VALUES
    ...
    (1, 19, 8.8),
    (1, 20, 8.0),
    (2, 20, 7.8), /* two films for one deal */
    (1, 21, 8.1), /* Chicago */
    (2, 22, 9.3),
    (3, 23, 7.4),
    (4, 24, 8.7),
    ...
    (2, 29, 8.9),
    (1, 30, 8.3),
    (4, 30, 8.5), /* two films for one deal */
    (1, 31, 9.5), /* Denver */
    (2, 32, 9.2),
    (3, 33, 6.8),
    (4, 34, 8.5),
    ...
    (2, 39, 8.7),
    (3, 40, 7.0),
    (5, 40, 8.3); /* two films for one deal */
